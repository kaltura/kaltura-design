...
<footer id="kaltura-footer">
	<div class="container_3">
		...
		<div id="kaltura-footer-social">
			...
			<a href="http://www.kaltura.org/kaltura-channel-freenode-irc-online-chat"><img alt="Freenode IRC" src="<?php echo htmlspecialchars( $this->text('stylepath') ); ?>/html5video/kaltura-images/kaltura-icon-chat.png"></a>
		...
		<div id="kaltura-copyright">
			<div id="kaltura-footer-logo">
				<a href="http://corp.kaltura.com"><img src="<?php echo htmlspecialchars( $this->text('stylepath') ); ?>/html5video/kaltura-images/kaltura-footer-logo.png" width="120" height="65"></a>
			</div>
